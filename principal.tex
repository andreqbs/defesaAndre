...
%% USO DAS FERRAMENTA\emph{}S NECESSÁRIAS AO USO DESTE MODELO (LATEX, XFIG, ETC.)
%%
...
\harvardparenthesis{round}	% Colchetes nas chamadas
...
%\usepackage{makeglo}
%
%\renewcommand{\glossaryname}{Lista de Abreviaturas e Siglas}
%\makeglossary

%\Glossary{FDI}{\emph{Fault Detection and Identification}}
...
%\addcontentsline{toc}{chapter}{Lista de Símbolos e Abreviaturas}
% O argumento opcional do comando \printglossary é a largura deixada
...
\include{listas/siglas}

% Cap. 1 - Introdução
\include{introducao/introducao}
% Cap. 2- Conceitos e Definições Preliminares
\include{fundamentacao/simbolismo}
\include{fundamentacao/redeNeurais}
\include{fundamentacao/integracao}
% Cap. 3 - Metodologia (Clustering)
\include{metodologia/met}
% Cap. 4 - Resultados
\include{resultados/resultados}
%Cap. 5 - Conclusões
\include{conclusao/conclusao}
\include{referencias/ref}
