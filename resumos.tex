...
\mychapterast{Resumo}
Um dos principais objetivos da inteligência artificial é a criação de agentes com a inteligência humana. Isso vem sendo pesquisado utilizando várias abordagens, e entre as mais promissoras para o aprendizado de máquinas são os sistemas simbólicos baseados na lógica e as redes neurais artificiais. Até a última década, ambas as abordagens progrediam de forma independente, mas os progressos obtidos em ambas as áreas fizeram com que os pesquisadores começassem a investigar maneiras de integrar ambas as abordagens. Diversos modelos que proporcionam a integração híbrida ou integrada dessas abordagens surgiram na década de 90, e continuam sendo utilizados até hoje. Esse trabalho tem como objetivo principal a implementação do algoritmo de conversão Neuro-Simbólica do sistema híbrido KBANN (Knowledge-Based Artificial Neural Networks), o qual possui a capacidade de mapear as dependências de um domínio específico de regras (se-então) em uma rede neural, e então refinar essa rede utilizando técnicas de aprendizado. Além disso, como esse modelo não possui a habilidade de refinar a topologia da rede em busca de se obter novas regras para o domínio inicial, foi necessário implementar um outro algoritmo ao modelo original do KBANN, afim de se obter possíveis expansões da rede original do KBANN.
