...
Nesta subseção, é descrito, em detalhes, cada uma das sete etapas desse algoritmo. 
...
A próxima etapa do algoritmo de traduçã é criar uma rede neural mapeando a estrutura hierárquica das regras em uma rede. Como resultado, há pouca diferença visual entre as representações da inicial rede KBANN no painel \emph{d} e a estrutura hierárquica das regras no painel \emph{c}.
