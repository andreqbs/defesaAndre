...
O TopGen começa treinando a rede na \ref{fig:topGenNos}c, obtendo nenhuma melhora na base de regra original. Em seguida, prossegue tomando exemplos mal classificados do conjunto de validação-1 para encontrar lugares onde pode ser benéfico adicionar "nós". O exemplo a seguir da categoria A é classificado incorretamente pela teoria de domínio:
%$\no F G  H \no I \no J \no  K L M$.
