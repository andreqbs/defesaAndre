...
\begin{figure}[H] 
	\begin{center}
		\caption{Grafo de fluxo de sinal mostrando o processo de retro-propagação dos sinais de erro na camada de saída para um neurônio $j$ da camada escondida imediatamente a esquerda. $m_L$ e é o número de neurônios da camada de saída.}
