...
\newline
\newline
\textbf{Resultados:}  As tabelas a seguir(\ref{tab:teste1Falsos10} à \ref{tab:teste1Falsos50}) e a Figura \ref{fig:regrasAdicionadas} resumem os resultados obtidos no primeiro teste.
...
\newline 
\newline
\textbf{Resultados:}  As tabelas a seguir(\ref{tab:teste2Falsos10} à \ref{tab:teste2Falsos50}) abaixo e a Figura \ref{fig:retiradaAntecedentes} resumem os resultados obtidos no segundo teste.
...
\newline 
\newline
\textbf{Resultados:} As tabelas a seguir(\ref{tab:teste3Falsos10} à \ref{tab:teste3Falsos50}) e a Figura \ref{fig:regrasDeletadas} resumem os resultados obtidos no terceiro teste.
...
\begin{figure}[H] 
	\begin{center}
		\caption{Porcentagem de erros x retirada de regras}
...
\newline 
\newline
\textbf{Resultados:}  As tabelas a seguir(\ref{tab:teste4Falsos10} à \ref{tab:teste4Falsos50}) e Figura \ref{fig:antecedenteDeletados} resumem os resultados obtidos no último teste.
