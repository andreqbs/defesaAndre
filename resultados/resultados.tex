...
Alguns dos testes aplicados utilizaram uma RNA contendo quatro camadas (53 x 30 x 3 x 1) (Figura X), mas essa distribuição dos neurônios sofreu variações durante os testes. O número de conexões entre a primeira e a segunda camada totalizou XX sinapses . O número de neurônios internos XX  equivale ao número de regras constituídas diretamente por peças, conforme a Figura \ref{fig:xadrezRegras}. As conexões entre a camada interna e a camada de saída são 180, visto que o resultado final é representado apenas por um neurônio na última camada (ilegal ou não).
...
\begin{table}[h]
	\centering
	\caption{Teste 2 : Falsos positivos e negativos dos neurônios, quando adicionado 10\% novos antecendetes às regras.}
	\vspace{0.5cm}
...
\begin{table}[h]
	\centering
	\caption{Teste 2 : Falsos positivos e negativos dos neurônios, quando adicionado 20\% novos antecendetes às regras.}
	\vspace{0.5cm}
...
\begin{table}[h]
	\centering
	\caption{Teste 2 : Falsos positivos e negativos dos neurônios, quando adicionado 30\% novos antecendetes às regras.}
	\vspace{0.5cm}
...
\begin{table}[h]
	\centering
	\caption{Teste 2 : Falsos positivos e negativos dos neurônios, quando adicionado 40\% novos antecendetes às regras.}
	\vspace{0.5cm}
...
\begin{table}[h]
	\centering
	\caption{Teste 2 : Falsos positivos e negativos dos neurônios, quando adicionado 50\% novos antecendetes às regras.}
	\vspace{0.5cm}
