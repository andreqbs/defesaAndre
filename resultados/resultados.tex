...
\vspace{0.5em}
\noindent
\textbf{Avaliação:} Pode-se observar que a rede KBANN já não consegue desempenhar um bom papel quando retiradas regras do domínio inicial. Nesse teste, a quantidade de erros nos neurônios de conclusões intermediárias e conclusão final ficaram taxas elevadas de falsos positivos e negativos, sendo assim, existiu a necessidade de aplicar o TopGen a fim de adicionar novos neurônios a rede com intuito de diminuir tais erros. Como pode ser visto, o TopGen, gerou resultados interessantes diminuindo consideravelmente o erro em cada neurônio. No neurônio MI, o TopGen obteve uma melhora de 43\% nas classificações de falsos positivos, em contra partida, o neurônio CD teve um leve aumento na sua taxa de erro de falsos positivos.
...
\vspace{0.5em}
\noindent
\textbf{Avaliação:}  Da mesma forma que aconteceu no caso anterior, o KBANN teve um crescente erro em sua classificação de movimento ilegal. A remoção de antecedentes teve uma influência maior do que a remoção de uma regra completa em ambos os algoritmos. A retirada de antecedentes permite que neurônios sejam ativados devido a um pequeno conjunto de conjunções existentes nas regras, ou seja, enquanto anteriormente eram necessários ter até 4 condições verdadeiras para ativar um neurônio, nesse momento, com apenas um o neurônio de uma conclusão intermediária pode ser ativado de forma errada.
