...
As pertubações na teoria do domínio foram feitas de 4 (quatro) maneiras diferentes: (a) adicionando um antecedente a uma regra, (b) removendo um antecedente de uma regra, (c) adicionando uma regra, ou (d) removendo uma regra. Essas pertubações foram feitas de forma aleatória, desde que não implicasse na retirada de alguma conclusão final. 
...
Para todos os testes desmonstrados abaixo, foi considerado um conjunto de dados com 10.000 amostras, sendo, 60\% para o treinamento, 20\% para validação e 20\% para teste. A taxa de aprendizagem considerada foi de 0.01 e com um número máximo de épocas de 10.000.
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
		...
		Domínio Teórico                                                                         & 59          & 65          & 22          & 38          & 18          & 80          & 19          & 57          \\ \hline
	\end{tabular}
\end{table}
  \vspace{-1.2em}
\centerline{Fonte: Autor, 2017}
...
Para o caso de antecedentes seram adicionados a regras já existentes, foram escolhidos aleatóriamente e adicionados a regras já existentes, desde que, não ultrapassse 4 antecedentes por regra.
\newline
\newline
...
Para esse teste, todas as regras removidas seguiram a condição de não excluir permanentemente uma conclusão intermediária ou final da rede.
\newline
\newline
\textbf{Objetivo:} Realizar uma comparação entre uma rede neural padrão, a rede KBANN e o TopGen quando o domínio teórico sofre a pertubação com a exclusão de regras.
\newline 
\newline
...
No último teste, os antecedentes das regras também foram retirados de forma aleatória. Mesmo não possuindo nenhuma ligação com algum consequente no domínio teórico a ser testado, todos os neurônios iram permanecer na topologia inicial da rede.
\newline
\newline
\textbf{Objetivo:} Realizar uma comparação entre uma rede neural padrão, a rede KBANN e o TopGen quando o domínio teórico sofre a pertubação com a exclusão de antecedentes nas regras.
\newline \newline
